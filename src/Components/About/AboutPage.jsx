...
function AboutPage() {
  ...
  return (
    ...
    <div className="mainAboutPage" id="mainAboutPage">
      <div
        ...
        // style={{ backgroundImage: `url(${earthquakebackground})` }}
      >
    ...
    <BsChevronCompactRight onClick={nextSlide} size={30} />
        ...
        <div className="px-4">
          ...
          <div className="text-md font-normal text-justify">
            ...
            like seismometers, earthquakes are classified by their magnitude on
            scales like the Richter or moment magnitude scale.
            <p> Our website aims
            to raise awareness and provide timely alerts to users about
            potential earthquakes. The impacts of earthquakes can be
            catastrophic, leading to damage to infrastructure, loss of life, and
            triggering secondary hazards like landslides and tsunamis.
            Mitigating earthquake risk involves resilient infrastructure,
            building codes enforcement, education, and early warning systems to
            minimize the impact on communities.</p>
          </div>
        </div>
  ...
  <div className="hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer">
    <BsChevronCompactRight onClick={nextSlide} size={30} />
      ...
      <iframe height="600" src="https://www.youtube.com/embed/A_j6_7bmY20?si=uJ-jtMGhN5nIBzVR" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen
